...
PS1='$(if [ \j -gt 0 ]; then echo [\j] ; fi)\u \w$(__git_ps1) \$ '
# PS1='\u@\h \w \$ '
# PS1='\033[38;5;180m\u@\h \w \$\033[0m '

# misc
alias ls="ls --color"
alias ll="ls -lah --color"
alias lsgrep="ls -lah --color | grep"
alias skak="sudo kak "
alias ripmp3="youtube-dl --extract-audio --audio-quality 0 -o ~/Music/%\(title\)s.%\(ext\)s"
alias venvmk="python -m venv venv"
